...
cmd = ["gcloud", "compute", "ssh", "curezyai-std", "--zone=us-central1-a", "--command", "cat > vllm_setup.sh"]
process = subprocess.Popen(cmd, stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=subprocess.PIPE, text=True, shell=True, encoding='utf-8')
